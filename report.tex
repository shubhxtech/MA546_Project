...
\begin{titlepage}
    ...
    {\includegraphics[width=3cm]{example-image-a}\par}   % replace with IIT Mandi logo if available
    \vspace{0.5cm}
    ...
    {\LARGE \textbf{\color{IITBlue}
        India NLP Quant Research Terminal:\\[0.3em]
        A News-Driven Sustainable Portfolio System}\par}
    ...
    \begin{tabular}{ll}
        \textbf{Team Name:}  & Dhurandhar \\[4pt]
        \textbf{Member 1:}   & Aditi Gupta \hspace{2cm} B23XXX \\[2pt]
        \textbf{Member 2:}   & Siddhi Pogakwar \hspace{1.3cm} B23XXX \\[2pt]
        \textbf{Member 3:}   & Anamika Godara \hspace{1.4cm} B23XXX \\[2pt]
        \textbf{Member 4:}   & Shubh Sahu \hspace{1.9cm} B23358 \\[4pt]
        \textbf{Supervisor:} & Dr.\ [Supervisor Name] \\[4pt]
        \textbf{Submitted:}  & May 2025 \\
    \end{tabular}

    \vspace{1.2cm}
    \begin{mdframed}[linecolor=IITBlue, linewidth=1pt, innerleftmargin=12pt, innerrightmargin=12pt]
        \centering
        \textbf{Submission Package:}\\[4pt]
        \texttt{Dhurandhar\_B23358\_Project.zip}\\[4pt]
        \begin{tabular}{cl}
            1. & \texttt{Dhurandhar\_B23358\_Project\_report.pdf} \\
            2. & \texttt{Dhurandhar\_B23358\_Project\_code/} \\
        \end{tabular}
    \end{mdframed}
...
Source            & Kaggle Dataset: \textit{Economic Times Headlines India 2022--2025} (abhiaero, 2025) \\
Dataset URL       & \url{https://www.kaggle.com/datasets/abhiaero/economic-times-headlines-india-2022-to-2025} \\
Timeframe         & January 2022 -- December 2025 \\
Format            & Four CSV files (one per year): headline text + publication date \\
Volume            & $>$100,000 deduplicated headlines after MD5 deduplication \\
Coverage          & NSE/BSE equities, macroeconomic policy, ESG and SDG events \\
Duplication Rate  & $\approx$35\% of raw articles are cross-site syndicate copies, removed via MD5 hashing \\
Storage           & Cached in \texttt{nlp\_cache.json} (47 MB) after NLP scoring \\
\bottomrule
\end{tabular}
\end{table}
...
Siddhi Pogakwar & Machine Learning Lead &
...
Anamika Godara & Quant Strategy Lead &
...
Shubh Sahu & Architecture \& UI Lead &
...
\begin{enumerate}[leftmargin=2em, itemsep=4pt, label={[\arabic*]}]
    ...
    \item abhiaero. (2025). \textit{Economic Times Headlines India 2022--2025} [Dataset]. Kaggle. \url{https://www.kaggle.com/datasets/abhiaero/economic-times-headlines-india-2022-to-2025}
